...
public class Matériel {
	...
	public Matériel(Long id_matériel, String modéle, Date date_achat, Date date_expiration_garantie,
	...
	public Matériel(Long id_materiel, String modele, Date date_achat, Date date_expiration_garantie,
			String emplacement) {
		super();
		this.id_materiel = id_materiel;
		this.modele = modele;
